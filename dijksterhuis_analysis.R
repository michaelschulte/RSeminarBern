...
dat$hupf_corr_pct <- ((rowSums(dat[,hupf_corr_cols] == 'True'))/3)/3

#skipping was not possible, so we do not need the skip-parts.
...
# 
# 
# ### These following steps seem kinda unnecessary. 
...
# }
# 
# dat$prime_condition <- relevel(dat$prime_condition, 'Universitätsprofessor')
...
# prof_scores <- dat$correct_pct[dat$prime_condition == 'Universitätsprofessor']
# prof_skip <-dat$correct_skip_pct[dat$prime_condition == 'Universitätsprofessor']
# hool_scores <- dat$correct_pct[dat$prime_condition == 'Fußballhooligan']
# hool_skip <- dat$correct_skip_pct[dat$prime_condition == 'Fußballhooligan']
...
# f_prof_scores <- dat$correct_pct[dat$prime_condition=='Universitätsprofessor' & dat$sex_r=='female']
# f_prof_skip <- dat$correct_skip_pct[dat$prime_condition=='Universitätsprofessor' & dat$sex_r=='female']
# f_hool_scores <- dat$correct_pct[dat$prime_condition=='Fußballhooligan' & dat$sex_r=='female']
# f_hool_skip <- dat$correct_skip_pct[dat$prime_condition=='Fußballhooligan' & dat$sex_r=='female']
...
# 
# m_prof_scores <- dat$correct_pct[dat$prime_condition=='Universitätsprofessor' & dat$sex_r=='male']
# m_prof_skip <- dat$correct_skip_pct[dat$prime_condition=='Universitätsprofessor' & dat$sex_r=='male']
# m_hool_scores <- dat$correct_pct[dat$prime_condition=='Fußballhooligan' & dat$sex_r=='male']
# m_hool_skip <- dat$correct_skip_pct[dat$prime_condition=='Fußballhooligan' & dat$sex_r=='male']
